export function renderCo2Chart() {
    if (document.getElementById("co2-chart") && document.getElementById("tooltip-co2")) {
        ...
        d3.csv("/historical_data.csv").then(data => {
            ...
            // Group data by date and calculate average CO2air and standard deviation (error)
            ...
            function applyFilter(filterOption) {
                ...
                if (filterOption === "monthly-co2") {
                    ...
                    console.log("Filtered Data (Weekly-co2):", filteredData);
                }
            ...
            function updateChart(data) {
                // Remove old elements (path-co2, dots, error bars, etc.)
                ...
                if (timeRange > 8 * 24 * 60 * 60 * 1000) {
                    ...
                    groupedData = d3.rollup(data,
                        v => {
                            const avg = d3.mean(v, d => d.avg); // Use 'avg' from grouped data, not CO2air
                ...
                // Sort the array by date to ensure correct path-co2 drawing
                ...
                console.log("y-axis data:", groupedArray.map(d => d.avg)); // Logs the average CO2air values being passed to y
                ...
                // Append the area path-co2 with the gradient fill
                svg.append("path")
                    .datum(groupedArray)
                    .attr("class", "area-co2")
                    .attr("d", area)
