                        ...
                        <div class="row-col-12">
                            ...
                            <div class="ml-1 mr-1 mb-3 p-3 shadow-sm rounded" style="background-color: #F2E5F7">
                                <div class="d-flex flex-row align-items-center justify-content-between">
                                    <div class="d-flex flex-row align-items-center">
                                        <div class="p-0.5">
                                            <img style="width: 68%" src="../assets/img/temperature-icon.png"
                                    ...
                                    <div>
                                        <p class="mb-0" style="color: #7E00AC; font-size: 200%; font-weight: bold;">
                                            {{ current_data[0]?.temperature || 'N/A' }}<sup
                                                style="font-size: 50%; top: -1rem">&deg;C</sup>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="ml-1 mr-1 mb-3 p-3 shadow-sm rounded" style="background-color: #EDF3FD">
                                <div class="d-flex flex-row align-items-center justify-content-between">
                                    <div class="d-flex flex-row align-items-center">
                                        <div class="p-0.5">
                                            <img style="width: 68%" src="../assets/img/humidity-icon.png"
                                                alt="humidity_icon" />
                                        </div>
                                        <div class="p-0.5">
                            ...
                            <div class="ml-1 mr-1 mb-3 p-3 shadow-sm rounded" style="background-color: #FDFAF1">
                                <div class="d-flex flex-row align-items-center justify-content-between">
                                    <div class="d-flex flex-row align-items-center">
                                        <div class="p-0.5">
                                            <img style="width: 68%" src="../assets/img/light-icon.png"
                                                alt="light_intensity_icon" />
                                        </div>
                                        <div class="p-0.5">
                                ...
                                <div class="d-flex flex-row align-items-center justify-content-between">
                                    ...
                                    <div>
                                        <p class="mb-0" style="color: #8A8A8A; font-size: 200%; font-weight: bold;">
                                            {{ current_data[0]?.co2 || 'N/A' }}<sup
                                                style="font-size: 50%; top: -1rem">ppm</sup>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row-col-12" v-if="predicted_data.length">
                            ...
                            <div class="ml-1 mr-1 mb-3 p-3 shadow-sm rounded" style="background-color: #F2E5F7">
                                <div class="d-flex flex-row align-items-center justify-content-between">
                                    ...
                                    <div>
                                        <p class="mb-0" style="color: #7E00AC; font-size: 200%; font-weight: bold;">
                                            {{ predicted_data[0]?.temperature || 'N/A' }}<sup
                                                style="font-size: 50%; top: -1rem">&deg;C</sup>
                                        </p>
                                    </div>
                                </div>
